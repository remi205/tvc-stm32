/////////////////////////////////////////////////////////////////////////
// File : d:/Lisp/Production/stm32-svd/macro-c/tim2.h
// 
//
...
// Return the value of register Or1
//
// Notes : Internal trigger 1 remap 
//        (OR1) at the offset 0x50, Bits 0:0
//
/////////////////////////////////////////////////////////////////////////
#define WRITE_ITR1_RMP(val) \
   {\
     ULONG OldValue = READ_REGISTER_ULONG( 0x50); \
     WRITE_REGISTER_ULONG(0x50, (OldValue & ~ ITR1_RMP_MASK) | ((val << ITR1_RMP_START_BIT) & ITR1_RMP_MASK )); \
   } 

#define ENABLE_ITR1_RMP() \
   {\
     ULONG val = READ_REGISTER_ULONG(0x50); \
     WRITE_REGISTER_ULONG( 0x50 , val |  ITR1_RMP_MASK ); \
   }

#define DISABLE_ITR1_RMP() \
   {\
     ULONG val = READ_REGISTER_ULONG(0x50); \
     WRITE_REGISTER_ULONG(0x50, val & ~ITR1_RMP_MASK ); \
   } 

#define READ_ITR1_RMP() \
   ((READ_REGISTER_ULONG(0x50) & ITR1_RMP_MASK)  >> ITR1_RMP_START_BIT)

#define WHEN_ITR1_RMP_HIGH() \
     if ( READ_ITR1_RMP() )


#define UNLESS_ITR1_RMP_HIGH() \
     if (! READ_ITR1_RMP() )


#define WAIT_ITR1_RMP_LOW() \
    while ( READ_ITR1_RMP() );


#define WAIT_ITR1_RMP_LOW_WITH_TIMEOUT(timeout) \
   { unsigned long ___t___ = timeout; while ( READ_ITR1_RMP() && (--___t___ > 0)); }


#define WAIT_ITR1_RMP_HIGH() \
    while (! READ_ITR1_RMP() );
...
// Return the value of register Or1
//
// Notes : External trigger remap 
//        (OR1) at the offset 0x50, Bits 1:1
//
/////////////////////////////////////////////////////////////////////////
#define WRITE_ETR1_RMP(val) \
   {\
     ULONG OldValue = READ_REGISTER_ULONG( 0x50); \
     WRITE_REGISTER_ULONG(0x50, (OldValue & ~ ETR1_RMP_MASK) | ((val << ETR1_RMP_START_BIT) & ETR1_RMP_MASK )); \
   } 

#define ENABLE_ETR1_RMP() \
   {\
     ULONG val = READ_REGISTER_ULONG(0x50); \
     WRITE_REGISTER_ULONG( 0x50 , val |  ETR1_RMP_MASK ); \
   }

#define DISABLE_ETR1_RMP() \
   {\
     ULONG val = READ_REGISTER_ULONG(0x50); \
     WRITE_REGISTER_ULONG(0x50, val & ~ETR1_RMP_MASK ); \
   } 

#define READ_ETR1_RMP() \
   ((READ_REGISTER_ULONG(0x50) & ETR1_RMP_MASK)  >> ETR1_RMP_START_BIT)

#define WHEN_ETR1_RMP_HIGH() \
     if ( READ_ETR1_RMP() )


#define UNLESS_ETR1_RMP_HIGH() \
     if (! READ_ETR1_RMP() )


#define WAIT_ETR1_RMP_LOW() \
    while ( READ_ETR1_RMP() );


#define WAIT_ETR1_RMP_LOW_WITH_TIMEOUT(timeout) \
   { unsigned long ___t___ = timeout; while ( READ_ETR1_RMP() && (--___t___ > 0)); }


#define WAIT_ETR1_RMP_HIGH() \
    while (! READ_ETR1_RMP() );
...
// Return the value of register Or1
//
// Notes : Input Capture 4 remap 
//        (OR1) at the offset 0x50, Bits 2:3
//
/////////////////////////////////////////////////////////////////////////
#define READ_TI4_RMP() \
   ((READ_REGISTER_ULONG(0x50) & TI4_RMP_MASK)  >> TI4_RMP_START_BIT)

#define WRITE_TI4_RMP(val) \
   {\
     ULONG OldValue = READ_REGISTER_ULONG( 0x50); \
     WRITE_REGISTER_ULONG(0x50, (OldValue & ~ TI4_RMP_MASK) | ((val << TI4_RMP_START_BIT) & TI4_RMP_MASK )); \
   } 
...
// Return the value of register Or2
//
// Notes : ETR source selection 
//        (OR2) at the offset 0x60, Bits 14:16
//
/////////////////////////////////////////////////////////////////////////
#define READ_ETRSEL() \
